---
title: 'Overview'
description: 'Auto-generated overview for System.'
editUrl: false
sidebar:
  hidden: true
  order: 1
...
- [Segment Heap](/docs/win-config/system/enable-segment-heap/)
...
- [Timestamp Interval](/docs/win-config/system/disable-timestamp-interval/)
